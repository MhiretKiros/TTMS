...
const RentCarTable = ({ cars, onEdit, onDelete, onView }: {
  cars: RentCar[];
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {cars.map((car) => (
            ...
            >
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.companyName}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.vehiclesUserName}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{car.vehiclesUserPhone}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.model}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.vehiclesType}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.manufactureYear}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.motorCapacity} cc</td>
