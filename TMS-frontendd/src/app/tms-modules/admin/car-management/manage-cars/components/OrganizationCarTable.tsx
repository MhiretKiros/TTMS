        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {cars.map((car) => (
            ...
            >
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.driverName || 'N/A'}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{car.loadCapacity} kg</td>
