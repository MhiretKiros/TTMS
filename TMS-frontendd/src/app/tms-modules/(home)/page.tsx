    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Transportation Management System</h1>
      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Choose Our TMS?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-3">Fleet Optimization</h3>
              <p className="text-gray-600">
                Our system reduces operational costs by up to 30% through intelligent routing and maintenance scheduling.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-semibold mb-3">Real-time Tracking</h3>
              <p className="text-gray-600">
                Monitor all vehicles in real-time with our advanced GPS tracking technology.
              </p>
            </div>
          </div>
        </div>
