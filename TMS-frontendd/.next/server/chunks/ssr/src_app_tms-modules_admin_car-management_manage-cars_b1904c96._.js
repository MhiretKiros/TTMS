...
const ManageCars = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadCars = async ()=>{
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCars"])();
                if (response.success) {
    ...
    const handleSubmit = async (carData)=>{
        try {
            let response;
            if (editingCar) {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateCar"])(carData.id, carData);
            } else {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createCar"])(carData);
            }
            if (response.success) {
    ...
    const handleDelete = async (id)=>{
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteCar"])(id);
            if (response.success) {
...
//# sourceMappingURL=src_app_tms-modules_admin_car-management_manage-cars_b1904c96._.js.map