(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_tms-modules_admin_car-management_manage-cars_f2a407d7._.js", {

"[project]/src/app/tms-modules/admin/car-management/manage-cars/api/carService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/framer-motion/dist/es/render/components/motion/proxy.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/tms-modules/admin/car-management/manage-cars/api/carService.ts [app-client] (ecmascript)");
...
const ManageCars = ()=>{
        ...
        "ManageCars.useEffect": ()=>{
            const loadCars = {
                "ManageCars.useEffect.loadCars": async ()=>{
                    try {
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCars"])();
                        if (response.success) {
    ...
    const handleSubmit = async (carData)=>{
        try {
            let response;
            if (editingCar) {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCar"])(carData.id, carData);
            } else {
                response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCar"])(carData);
            }
            if (response.success) {
    ...
    const handleDelete = async (id)=>{
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$tms$2d$modules$2f$admin$2f$car$2d$management$2f$manage$2d$cars$2f$api$2f$carService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCar"])(id);
            if (response.success) {
...
//# sourceMappingURL=src_app_tms-modules_admin_car-management_manage-cars_f2a407d7._.js.map