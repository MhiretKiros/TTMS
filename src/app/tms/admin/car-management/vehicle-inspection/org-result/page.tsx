// src/app/tms/admin/car-management/vehicle-inspection/result/page.tsx
'use client';
...
export default function CarInspectionResultPage() {
    ...
    const fetchInspectionDetails = useCallback(async () => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/api/org-inspections/get/${inspectionId}`, {
                method: 'GET',
                headers: {
                ...
                <div ref={componentRef}>
                    <div className="bg-white rounded-lg shadow-xl overflow-hidden">
                        ...
                        <div className="bg-gray-100 px-6 py-4 text-center text-sm text-gray-600 border-t border-gray-200">
                            ...
                            <button onClick={() => router.push('/tms/admin/car-management/vehicle-inspection')} className="mt-2 text-blue-600 hover:underline text-xs">
