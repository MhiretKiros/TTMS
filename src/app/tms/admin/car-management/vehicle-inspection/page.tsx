                          ...
                          if (car.inspected) {
                            ...
                            if (car.latestInspectionId) { // Use car.latestInspectionId
                              ...
                              const resultPagePath = activeTab === 'organization'
                                ? `/tms/admin/car-management/vehicle-inspection/org-result?inspectionId=${car.latestInspectionId}`
                                : `/tms/admin/car-management/vehicle-inspection/result?inspectionId=${car.latestInspectionId}`;
