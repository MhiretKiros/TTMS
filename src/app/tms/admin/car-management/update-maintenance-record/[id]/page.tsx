  ...
  const onSubmit = async (data: UpdateMaintenanceFormData) => {
    ...
    try {
      ...
      if (data.isProblemFixed) {
        ...
        setTimeout(() => {
          router.push(`/tms/admin/car-management/add-maintenance-record?plateNumber=${record?.plateNumber}`);
        }, 1500);
      } else {
    ...
    <div className = "container mx-auto p-4 sm:p-6 lg:p-8 bg-slate-50 min-h-screen">
      ...
      <div className = "bg-white p-6 sm:p-8 rounded-xl shadow-2xl">
        <div className = "flex justify-between items-center mb-6 border-b border-slate-300 pb-4">
          ...
          <Link href={`/tms/admin/car-management/maintenance-records/${record.id}`} className="text-blue-600 hover:text-blue-800 flex items-center">
