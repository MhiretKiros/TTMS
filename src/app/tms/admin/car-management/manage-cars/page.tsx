...
export default function ManageCars() {
  ...
  const handleViewPersonalCar = (id: number) => {
    router.push(`/tms/admin/car-management/manage-cars/view-car/${id}`);
  };

  const handleViewOrganizationCar = (id: number) => {
    router.push(`/tms/admin/car-management/manage-cars/view-organization-car/${id}`);
  };

  const handleViewRentCar = (id: number) => {
    router.push(`/tms/admin/car-management/manage-cars/view-rent-car/${id}`);
  };
