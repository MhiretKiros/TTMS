...
const roleConfig = {
  ...
  adminCards: [
    ...
    { 
      href: '/tms-modules/admin/car-management/assign-car', 
      icon: <FiClipboard />, 
      label: 'Total Assignments' 
    },
    { 
      href: '/tms-modules/admin/users', 
      icon: <FiUsers />, 
      label: 'Total Users' 
    },
    { 
      href: '/tms-modules/admin/reports/car-reports', 
      icon: <FiFileText />, 
      label: 'All Reports' 
    },
  ],
  adminQuickActions: [
    { 
      href: '/tms-modules/admin/car-management/add-car', 
      icon: <FiPlusCircle />, 
      label: 'Add New Vehicle' 
    },
    { 
      href: '/tms-modules/admin/assign-vehicle', 
      icon: <FiClipboard />, 
    ...
    { 
      href: '/tms-modules/admin/maintenance-schedule', 
      icon: <FiSettings />, 
          ...
          >
            ...
            >
              ...
              <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                This interactive map displays the real-time location of all assigned vehicles across regions.
              </p>
            </motion.div>
